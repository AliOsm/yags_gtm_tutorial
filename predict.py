...
if __name__ == '__main__':
	data_dir = 'mnist_png'
	testing_dir = os.path.join(data_dir, 'testing') # mnist_png/testing
	...
	for i in range(10):
		...
		for filename in filenames:
			...
			# (224, 244)
			normalized_image_array = np.expand_dims(normalized_image_array, -1)
			# (224, 244, 1)
	...
	print(f'Accuracy: {round(correct / 10_000 * 100, 2)}%')
